...
1. Ensure you have the [.NET 10 runtime](https://dotnet.microsoft.com/en-us/download/dotnet/10.0) installed (on the download page, look for the latest ".NET Runtime 10.0.x" heading in the right-hand column).
